...
// @ts-ignore
export default function Filters({withExam, setWithExam, teacherFirstName, setTeacherFirstName, teacherLastName, setTeacherLastName, tags, setTags, tagsLoading, tagInputVisible, setTagInputVisible, tagInputValue, setTagInputValue, tagOptions, setTagOptions, tagInputRef, tagDropdownVisible, setTagDropdownVisible, searchTags, removeTag, showInput, onInputChange, onInputConfirm, resetFilters, applyFilters, style, className}) {
    return (
        <div className={className}>
            <div className={styles.filters} style={style}>
                ...
                <h4 style={{marginBottom: 5}}>Вступний екзамен:</h4>
                <Radio.Group
                    value={withExam}
                    onChange={e => {
                ...
                >
                    <Radio value={1}>Присутній</Radio>
                    <Radio value={2}>Відсутний</Radio>
                </Radio.Group>
